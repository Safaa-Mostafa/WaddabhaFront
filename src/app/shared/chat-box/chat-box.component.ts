import { AfterViewChecked, AfterViewInit, Component, ElementRef, Input, OnChanges, OnInit, QueryList, SimpleChanges, ViewChild } from '@angular/core';
...
export class MessagesComponent implements OnInit, OnChanges {
  ...
  sendMessage(): void {
   ...
   // this.receiverId = '7cfa8c83-300e-4293-98c9-c74ca11c0c49';
    if (newMessage){ //&& this.receiverId) {
      this.signalrService.sendMessage(this.profile.id, /*this.receiverId,*/ newMessage,this.ChatRoomId);
  ...
  loadChat(chatRoomId: string): void {
    ...
    this.signalrService.loadChat(chatRoomId).subscribe({next: (res) => {
